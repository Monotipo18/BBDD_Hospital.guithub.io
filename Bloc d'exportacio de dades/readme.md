...
### Contingut
  ...
  -  [Què és XmlTree](#què-és-xmletreeelementtree-i-xmldomminidom)

  -  [Funcionament XmlTree](#funcionament)

  -  [Resum Xmltree](#resum)

  -  [Què és Random Sample](#què-és-randomsample)

  -  [Funcionament Sample](#funcionament-sample)

  -  [Informes PowerBi](#informes-en-powerbi)
...
Després de crear l'element arrel és necessari crear suplements arrel (en aquest cas 1, que es repetirà tantes vegades com sigui necessari)
...
Afegir subelements amb dades específiques de la visita
  ...
  -  Propòsit: Afegir detalls específics de cada visita com suplements de l'element "visita".
...
Formatar l'XML perquè estigui ben identat i tabulat
...
## Resum
  ...
  -  3. Formata l'XML: Utilitza minidom per afegir indentació i fer que l'XML sigui més llegible.
...
Els informes que s'han adjuntat haurien de ser amb un ```current_date``` perque nomes es pugui visualitzar el mateix dia y no diferents, això es perquè si l'informa es genera amb 

Moltíssims dies pot causar problemes o funcionar, a més que és més fàcil de visualitzar.
