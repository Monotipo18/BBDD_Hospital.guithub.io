                    ...
                    if administrador:
                        ...
                        while opcion!="4":
                            ...
                            if opcion == "1":
                                ...
                                menu_exportacio_dades()
                                fecha_visita1 = input("Di la fecha inicial del rango de visitas: ")
                                fecha_visita2 = input("Di la fecha final del rango de visitas: ")
                                visitas_entre_fechas(fecha_visita1, fecha_visita2)
                            elif opcion  == "4":
                                print("Saliendo del progrma")  
                                Centinela =  False                      
            elif opcion == "2":
