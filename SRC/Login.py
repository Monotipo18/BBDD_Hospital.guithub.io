    ...
    try:
        ...
        with open(archivo_csv, newline='', encoding='utf-8') as csvfile:
            ...
            for fila in lector_csv:
                ...
                if check_password_hash(usuario_hash, USUARIO) and check_password_hash(contraseña_hash, PASWORD):
                    ...
                    print("Credenciales no validades")
    except Exception as e:
        print("Error:", e)

#CREACION DE USUARIOS:

def Registro(USUARIO,PASWORD):
    conn = psycopg2.connect(
    dbname="pagila",
    user="postgres",
    password="P@ssw0rd",
